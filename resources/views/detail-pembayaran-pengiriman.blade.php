            ...
            <div class="row">
                <div class="col-12">
                    <div class="table-responsive">
                        <form id="paymentForm" method="POST" action="{{ route('konfimasi.pesanan.pengiriman') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="jenis_layanan" id="layanan" class="form-select w-50"
                                                ...
                                                <option value="basic" data-harga="200000">Basic</option>
                                                <option value="premium" data-harga="500000">Premium</option>
