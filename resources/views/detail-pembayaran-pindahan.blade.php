            ...
            <div class="row">
                <div class="col-12">
                    <div class="table-responsive">
                        <form id="paymentForm" method="POST" action="{{ route('konfimasi.pesanan.pindahan') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="jenis_layanan" id="layanan" class="form-select w-50"
                                                ...
                                                <option value="basic" data-harga="800000">Basic</option>
                                                <option value="premium" data-harga="1000000">Premium</option>
                                                <option value="advance" data-harga="1500000">Advance</option>
                                            </select>
                                        </td>
